...
bdutil is licensed to You (End-User) by Ancestral Laboratories for use only under the terms of this License Agreement.
...
bdutil, when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. bdutil is to be used on devices that operate with.
...
bdutil ("Licensed Application") is a piece of software created to facilitate bootable installer creation on media devices — and customized for mobile devices ("Devices"). It is used to create bootable installers on media devices with a copy of a disc image.
...
For general inquiries, complaints, questions or claims concerning the Licensed Application, please contact via Github at [the issues page](https://github.com/ancestral-labs/bdutil/issues).
