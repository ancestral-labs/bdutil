# 🌈 Welcome to the bdutil community!
...
🔧 Support for additional OS targets or filesystems\
📝 Documentation\
...
To file a bug or feature request, use [GitHub issues](https://github.com/ancestral-labs/bdutil/issues/new).

🚧 For unexpected behavior or usability limitations, detailed instructions on how to reproduce the issue are appreciated — including the macOS version, device identifier, and the image or installer used. This will greatly help the priority setting and speed at which maintainers can get to your issue.

### Pull requests

We require all commits be signed with any of GitHub's supported methods, such as GPG or SSH. Information on how to set this up can be found on [GitHub's docs](https://docs.github.com/en/authentication/managing-commit-signature-verification/about-commit-signature-verification).

To make a pull request, use [GitHub](https://github.com/ancestral-labs/bdutil/compare). Please give the team a few days to review but it's ok to check in on occasion. We appreciate your contribution!

> [!IMPORTANT]
> If you plan to make substantial changes or add new features, we encourage you to first discuss them by filing a [GitHub issue](https://github.com/ancestral-labs/bdutil/issues/new).
...
Make sure your contributions are consistent with the rest of the project's formatting. `bdutil` follows the standard Swift conventions. You can check formatting using SwiftLint:
...
If you submit a contribution that adds a new file, please add the Apache 2.0 license header. Use the following template:
...
Take a look at the `good first issue` label in the [bdutil issues](https://github.com/ancestral-labs/bdutil/contribute).
...
Don't be afraid to ask for help! When asking for help, provide as much information as possible, while highlighting anything you think may be important.
...
To clarify what is expected of our contributors and community members, the `bdutil` project has adopted the code of conduct defined by the Contributor Covenant. This document is used across many open source communities and articulates our values well. For more detail, please read the [Code of Conduct](CODE_OF_CONDUCT.md).

---

Parts of this document are adapted from the
